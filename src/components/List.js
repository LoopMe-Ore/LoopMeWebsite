      ...
      {/* <BtnDropdown Repos={repos} purpose={"department"} passData = {setQ}></BtnDropdown> */}
        <div className='hiring_search_filter_container'>
          ...
          <div className='search'>
            <img alt="search" id='inputSearch_img' loading="eager" src="assets/img/images/Hiring/search_icon.png"/>
            <input 
              type="search" 
              name="search-form" 
...
{/* Line 2 */}
          ...
          <div className='filter'>
            ...
            <img alt="filter" id='filter_loc_img' loading="eager" src="assets/img/images/Hiring/location_logo.png"/>
...
{/* WORKS */}
            ...
            {/* Filter By Countries */}
             <div id='filter_country_img' className='filter_country_img'>
              <img alt="filter" loading="eager" name="United Kingdom" src="assets/img/images/Hiring/Flag-UK.png" onClick={(e)  => toggleCountrySelect(e)}/>
              <img alt="filter" loading="eager" name="Ukraine" src="assets/img/images/Hiring/Flags-Ukraine.png" onClick={(e) => toggleCountrySelect(e)}/>
              <img alt="filter" loading="eager" name="Poland" src="assets/img/images/Hiring/Flags-Poland.png" onClick={(e) => toggleCountrySelect(e)}/>
              <img alt="filter" loading="eager" name="United States" src="assets/img/images/Hiring/Flags-Us.png" onClick={(e) => toggleCountrySelect(e)}/>
              <img alt="filter" loading="eager" name="Singapore" src="assets/img/images/Hiring/Flags-Singapore.png" onClick={(e) => toggleCountrySelect(e)}/>
            </div>
          ...
          return (
            ...
            <div key={i} className='list_hiring' onClick={event => window.open(repo.shortlink, '_blank').focus()}>
                  ...
                  <div className='repo-title hiringSec'>
                    <img alt="a pic" className="repo_tlt_pic" loading="eager" src="assets/img/images/Hiring/RectangleTitle.png"/>
                    <div>{repo.title}</div>
                  </div>

                  <div className='repo-city-state hiringSec'> {repo.city} {repo.state} </div>
                  <img alt="border" className="seperation_border" loading="eager" src="assets/img/images/Hiring/Vector12.png"/>
