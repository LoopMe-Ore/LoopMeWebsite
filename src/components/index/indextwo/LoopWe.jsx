	...
	<section ref={initiativesRef} className="lpWE-area">
				...
				{/* <!-- Full-width images with number and caption text --> */}
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/File1.png" alt='' ></img>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/File2.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/File3.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/File4.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/File5.png" alt='' ></img>
					</div>
