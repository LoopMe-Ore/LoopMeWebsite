				...
				{/* <!-- Full-width images with number and caption text --> */}
					<div className="mySlides fadeLpWe">
						<div className='lpWe_text'>
							<h2 className='headerLpWe'>Our Initiatives</h2>
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/min_File1.png" alt='' ></img>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/min_File2.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/min_File3.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/min_File4.png" alt='' ></img>
					</div>
					...
					<div className="mySlides fadeLpWe">
						...
						<img className="SlideShowImg" src="https://i.loopme.me/gwd/test/LP_website/img/images/Initiatives/min_File5.png" alt='' ></img>
					</div>
